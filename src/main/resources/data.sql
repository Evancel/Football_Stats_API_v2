...
INSERT
INTO player (first_name, last_name, team_id, goals, played_matches)
SELECT *
FROM (VALUES ('Ederson', 'Moraes', (SELECT id FROM team_id), 0, 0),
             ...
             ('Bernardo', 'Silva', (SELECT id FROM team_id), 0,
              0)) AS players(first_name, last_name, team_id, goals, played_matches);
...
INTO player (first_name, last_name, team_id, goals, played_matches)
SELECT *
FROM (VALUES ('Alisson', 'Becker', (SELECT id FROM team_id), 0, 0),
...
INTO player (first_name, last_name, team_id, goals, played_matches)
SELECT *
FROM (VALUES ('Thibaut', 'Courtois', (SELECT id FROM team_id), 0, 0),
...
INTO player (first_name, last_name, team_id, goals, played_matches)
SELECT *
FROM (VALUES ('Marc-André', 'ter Stegen', (SELECT id FROM team_id), 0, 0),
...
INTO player (first_name, last_name, team_id, goals, played_matches)
SELECT *
FROM (VALUES ('Manuel', 'Neuer', (SELECT id FROM team_id), 0, 0),
...
INTO player (first_name, last_name, team_id, goals, played_matches)
SELECT *
FROM (VALUES ('Pascal', 'Struijk', (SELECT id FROM team_id), 0, 0),
...
INTO player (first_name, last_name, team_id, goals, played_matches)
SELECT *
FROM (VALUES ('Samir', 'Handanovic', (SELECT id FROM team_id), 0, 0),
...
INTO player (first_name, last_name, team_id, goals, played_matches)
SELECT *
FROM (VALUES ('Gianluigi', 'Donnarumma', (SELECT id FROM team_id), 0, 0),
